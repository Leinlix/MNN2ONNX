...
namespace LLX {
    void ArgMaxOPConvertor::run(onnx::NodeProto *onnx_node , MNN::OpT *src_op, ConvertorScope *scope){
        onnx_node->set_op_type("ArgMax");
        ...
        // keepdims = 1 will split to argmax and squeeze
