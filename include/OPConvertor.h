...
DECLARE_OP_CONVERTOR(CastOPConvertor)
DECLARE_OP_CONVERTOR(ConvertTensorOPConvertor)
DECLARE_OP_CONVERTOR(ConvolutionDepthwiseOPConvertor)
DECLARE_OP_CONVERTOR(ConvolutionOPConvertor)
DECLARE_OP_CONVERTOR(InterpOPConvertor)
DECLARE_OP_CONVERTOR(PoolingOPConvertor)
DECLARE_OP_CONVERTOR(ReluOPConvertor)
DECLARE_OP_CONVERTOR(SeluOPConvertor)
DECLARE_OP_CONVERTOR(SigmoidOPConvertor)
DECLARE_OP_CONVERTOR(UnaryOPConvertor)
}